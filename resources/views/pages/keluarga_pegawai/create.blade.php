...
@section('title')
Documentation Create Keluarga Pegawai
@endsection
@section('content')
        ...
        <div class="col-xl-12">
            <div class="card shadow padding--medium">
                <div class="card-header p-0 border-0">
                    <div class="row">
                        <div class="col">
                            <h3 class="mb-0">Dokumentasi API Create Keluarga Pegawai</h3>
                        </div>
                    </div>
                </div>
                <hr class="my-4">
                            ...
                            <pre class="language-json alert alert-default" data-type="json">
                                <code class="language-json "> 
                                    { 
                                        ...
                                        "data": { 
                                            "id_keluarga": 1, 
                                            "keterangan": "baik baik saja", 
                                            "updated_at": "2021-08-12T20:28:52.000000Z", 
