...
@section('title')
Documentation Kirim Gambar Ke User
@endsection
@section('content')
        ...
        <div class="col-xl-12">
            <div class="card shadow padding--medium">
                <div class="card-header p-0 border-0">
                    <div class="row">
                        <div class="col">
                            <h3 class="mb-0">Dokumentasi API Kirim Pesan Ke User Dengan Gambar</h3>
                        </div>
                    </div>
                </div>
                <hr class="my-4">
                <div class="card-body p-0 border-0">
                    <div class="row">
                        <div class="col">
                            ...
                            <pre class="alert alert-default">http://127.0.0.1:8000/api/kepegawaian/sendImg</pre>
                        </div>
                    </div>
                    <hr class="my-2">
                    <div class="row">
                            ...
                            <table class="table align-items-center table-borderless table-flush table-hover">
                                ...
                                <tbody class="table-body">
                                    <tr>
                                        ...
                                        <td class="text-center">Nomor yang di tuju</td>
                                    </tr>
                                    <tr>
                                        <td class="text-center">pesan</td>
                                        <td class="text-center">string</td>
                                        <td class="text-center">isi dari pesan</td>
                                    </tr>
                                    <tr>
                                        <td class="text-center">img</td>
                                        <td class="text-center">string</td>
                                        <td class="text-center">gambar yang akan di kirimkan</td>
                                    </tr>
                                </tbody>
                            </table>
                        </div>
