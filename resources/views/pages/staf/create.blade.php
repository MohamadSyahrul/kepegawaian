        ...
        <div class="col-xl-12">
            <div class="card shadow padding--medium">
                <div class="card-header p-0 border-0">
                    <div class="row">
                        <div class="col">
                            <h3 class="mb-0">Dokumentasi API Create Staf</h3>
                        </div>
                    </div>
                </div>
                <hr class="my-4">
                <div class="card-body p-0 border-0">
                    <div class="row">
                        <div class="col">
                            ...
                            <pre class="alert alert-default">http://127.0.0.1:8000/api/kepegawaian/staf</pre>
                        </div>
                    </div>
                    <hr class="my-2">
                    <div class="row">
                                ...
                                <code class="language-json ">
                                    {
                                        ...
                                        "data": {
                                            "id_pegawai": "1",
                                            "staf": "pegawai",
                                            "updated_at": "2021-08-12T17:56:51.000000Z",
                                            "created_at": "2021-08-12T17:56:51.000000Z",
                                            "id": 3
                                        }
                                    }
                                </code>
