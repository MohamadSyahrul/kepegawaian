...
@section('title')
Documentation Update Pegawai Ttd Cuti
@endsection
@section('content')
        ...
        <div class="col-xl-12">
            <div class="card shadow padding--medium">
                <div class="card-header p-0 border-0">
                    <div class="row">
                        <div class="col">
                            <h3 class="mb-0">Dokumentasi API Update Pegawai Ttd Cuti</h3>
                        </div>
                    </div>
                </div>
                <hr class="my-4">
                <div class="card-body p-0 border-0">
                    <div class="row">
                        <div class="col">
                            ...
                            <pre class="alert alert-default">127.0.0.1:8000/api/kepegawaian/pegawai-ttd-cuti/2</pre>
                        </div>
                    </div>
                    <hr class="my-2">
                    <div class="row">
                                ...
                                <code class="language-json ">
                                    {
                                        ...
                                        "id_pegawai": "1",
                                        "jabatan": "pegawai",
                                        "created_at": "2021-08-12T20:08:19.000000Z",
                                        "updated_at": "2021-08-12T20:09:13.000000Z"
                                    }
                                </code>
                            </pre>
                        </div>
