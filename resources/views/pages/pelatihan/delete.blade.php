...
@section('title')
Documentation Delete Pelatihan
@endsection
@section('content')
        ...
        <div class="col-xl-12">
            <div class="card shadow padding--medium">
                <div class="card-header p-0 border-0">
                    <div class="row">
                        <div class="col">
                            <h3 class="mb-0">Dokumentasi API Delete Pelatihan</h3>
                        </div>
                    </div>
                </div>
                <hr class="my-4">
                <div class="card-body p-0 border-0">
                    <div class="row">
                        <div class="col">
                            ...
                            <pre class="alert alert-default">http://127.0.0.1:8000/api/kepegawaian/pegawai-pelatihan/3</pre>
                        </div>
                    </div>
                    <hr class="my-2">
                    <div class="row">
