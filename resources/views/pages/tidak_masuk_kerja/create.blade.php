...
@section('title')
Documentation Create Pegawai Tidak Masuk Kerja
@endsection
@section('content')
        ...
        <div class="col-xl-12">
            <div class="card shadow padding--medium">
                <div class="card-header p-0 border-0">
                    <div class="row">
                        <div class="col">
                            <h3 class="mb-0">Dokumentasi API Create Pegawai Tidak Masuk Kerja</h3>
                        </div>
                    </div>
                </div>
                <hr class="my-4">
                <div class="card-body p-0 border-0">
                    <div class="row">
                        <div class="col">
                            ...
                            <pre class="alert alert-default">http://127.0.0.1:8000/api/kepegawaian/pegawai-tidak-masuk-kerja?</pre>
                        </div>
                    </div>
                    <hr class="my-2">
                    <div class="row">
                        ...
                        <div class="table-responsive">
                            <table class="table align-items-center table-borderless table-flush table-hover">
                                ...
                                <tbody class="table-body">
                                    ...
                                    <tr>
                                        <td class="text-center">nomor_surat</td>
                                        <td class="text-center">integer</td>
                                        <td class="text-center">ulangi password</td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        <td class="text-center">tempat_kota</td>
                                        <td class="text-center">string</td>
                                        <td class="text-center">Masukan Nama Pegawai</td>
                                    </tr>
                                    <tr>
                                        <td class="text-center">tanggal_ttd</td>
                                        <td class="text-center">string</td>
                                        <td class="text-center">Masukan password</td>
                                    </tr>
                                    <tr>
                                        <td class="text-center">pegawai_ttd_cuti</td>
                                        <td class="text-center">integer</td>
                                        <td class="text-center">ulangi password</td>
                                    </tr>
                                    <tr>
                                ...
                                <code class="language-json ">
                                    {
                                        ...
                                        "data": {
                                            ...
                                            "keperluan": "coba",
                                            "tempat_kota": "jombang",
                                            "tanggal_ttd": "2021-07-08",
                                            "pegawai_ttd_cuti": "coba",
                                            "updated_at": "2021-08-12T19:14:56.000000Z",
                                            "created_at": "2021-08-12T19:14:56.000000Z",
                                            "id": 2
                                        }
                                    }
                                </code>
